...
train_dir = r'D:\MLLLLLL\Splited Dataset\train'
val_dir = r'D:\MLLLLLL\Splited Dataset\val'
test_dir = r'D:\MLLLLLL\Splited Dataset\test'
output_dir = r'D:\MLLLLLL\Model Output'
...
# Model Definition (Simple CNN for example)
model = Sequential([
